 ...
 def login() {
    withCredentials([
        ...
        sh """
            ...
            aws ecr get-login-password --region us-east-1 | kubectl create secret docker-registry regcred --docker-server=186753268376.dkr.ecr.us-east-1.amazonaws.com --docker-username=AWS --docker-password-stdin="$(cat -)" --namespace rsvpapp
        """  
    }
 }                 
/**
